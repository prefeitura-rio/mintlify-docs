...
- [Criação de Pipelines](/data-lake/tipos-de-pipeline/criacao-de-pipelines) — passo a passo para construir um novo pipeline
- [Prefect: Construindo uma Pipeline](/data-lake/prefect/construindo-uma-pipeline) — configuração e deploy no Prefect
- [Repositório pipelines_rj_sms](https://github.com/prefeitura-rio/pipelines_rj_sms) — exemplos de pipelines de saúde (SMS)
- [Repositório prefect_rj_iplanrio](https://github.com/prefeitura-rio/prefect_rj_iplanrio) — pipelines gerais da IplanRio
